...
![image-20250605101334024](/home/cacc/.config/Typora/typora-user-images/image-20250605101334024.png)
$$
\begin{cases}
...
![image-20250607141436671](/home/cacc/.config/Typora/typora-user-images/image-20250607141436671.png)
...
**例题** 可微函数 f(x, y) 的极值点必是 f(x, y) 的驻点。
...
![image-20250606113510590](/home/cacc/.config/Typora/typora-user-images/image-20250606113510590.png)
$$
...
$$
![image-20250607154404243](/home/cacc/.config/Typora/typora-user-images/image-20250607154404243.png)
...
**例题** 求 $\iint_\Sigma x^2 +y^2 dS$，其中 \Sigma 是由锥面 $z = \sqrt{x^2 + y^2}$ 及平面 $z = 1$ 所围成的整个边界曲面
